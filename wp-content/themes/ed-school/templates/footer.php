...
<?php if ( $footer_layout_block ): ?>
	<div class="<?php echo esc_attr( ed_school_class( 'footer' ) ) ?>">
		<div class="<?php echo esc_attr( ed_school_class( 'container_home_content' ) ) ?>">
...
<?php else: ?>
	<div class="<?php echo esc_attr( ed_school_class( 'footer' ) ) ?>">
		<?php if ( is_active_sidebar( 'wheels-sidebar-footer' ) ) : ?>
			<div class="<?php echo esc_attr( ed_school_class( 'footer-widgets-wrap' ) ) ?>">
