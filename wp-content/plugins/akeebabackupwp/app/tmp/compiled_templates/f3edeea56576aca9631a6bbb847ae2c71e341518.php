<?php /* /var/www/html/tlrfmdu/wp-content/plugins/akeebabackupwp/app/Solo/ViewTemplates/Wizard/wizard.blade.php */ ?>
<?php
/**
 * @package   solo
	...
	<div id="backup-progress-pane" style="display: none">
		...
		<div id="backup-progress-header" class="akeeba-panel--info">
            ...
            <div id="backup-progress-content">
				<div id="backup-steps">
					<div id="step-minexec" class="akeeba-label--grey"><?php echo $this->getLanguage()->text('COM_AKEEBA_CONFWIZ_MINEXEC'); ?></div>
					<div id="step-directory" class="akeeba-label--grey"><?php echo $this->getLanguage()->text('COM_AKEEBA_CONFWIZ_DIRECTORY'); ?></div>
					<div id="step-dbopt" class="akeeba-label--grey"><?php echo $this->getLanguage()->text('COM_AKEEBA_CONFWIZ_DBOPT'); ?></div>
					<div id="step-maxexec" class="akeeba-label--grey"><?php echo $this->getLanguage()->text('COM_AKEEBA_CONFWIZ_MAXEXEC'); ?></div>
					<div id="step-splitsize" class="akeeba-label--grey"><?php echo $this->getLanguage()->text('COM_AKEEBA_CONFWIZ_SPLITSIZE'); ?></div>
				</div>
